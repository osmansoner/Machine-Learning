# -*- coding: utf-8 -*-
"""
Created on Mon May 18 01:56:39 2020
...
#derste anlatılan kodda kullanılan bu kütüphane de değişmiş

from sklearn.model_selection import train_test_split
#we have to use train_test_split for gender estimate
...
#if we do the future scaling it would better we do with standardisation..
#standardisation ile yapmamız daha iyi olur çünkü outlier bir değer gelmesi durumda daha stabil olur.
sc = StandardScaler()
